...
export const appWithTranslation = <Props extends NextJsAppProps>(
  ...
  const AppWithTranslation = (props: Props & { pageProps: Props['pageProps'] & SSRConfig }) => {
    ...
    let locale: string | undefined = _nextI18Next?.initialLocale ?? props?.router?.locale;
    ...
    const i18n: I18NextClient | null = useMemo(() => {
      ...
      // const userConfig = mergeDeep(configOverride || {}, _nextI18Next?.userConfig);
      ...
      const resources = mergeDeep(configOverride?.resources || {}, initialI18nStore);

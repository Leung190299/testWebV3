  ...
  return (
    <>
      ...
      <SuccessView
        ...
        description={
          <>
            iTel đã tiếp nhận hồ sơ cập nhật TTTB của bạn và sẽ phản hồi kết quả trong vòng 24h.
            <br />
        ...
        questions="Bạn cập nhật TTTB có dễ dàng không? Hãy đánh giá ngay bên dưới nhé."
      />
    </>
  );
};

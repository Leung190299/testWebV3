  ...
  return (
    <div className={clsx('bg-neutral-0', className)}>
      <div className="container py-6 md:py-20">
        <h3 className="text-left md:text-center text-xl md:text-h-md font-itel font-bold">Câu hỏi thường gặp</h3>
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 md:gap-6 mt-4 md:mt-10">
          {QUESTIONS.map((item, index) => (
            <Link href={'/'} key={index} className="flex rounded-xl bg-neutral-100 overflow-hidden col-span-1">

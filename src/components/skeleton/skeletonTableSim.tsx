    ...
    <div className="grid grid-cols-4 gap-4">
      {itemSkeleton.map((value) => (
        <div
          key={value}
          role="status"
          className="max-w-sm border border-neutral-300 rounded-3xl shadow animate-pulse dark:border-neutral-500 mt-6 bg-neutral-50"
        >
...
export default SkeletonTableSim;
